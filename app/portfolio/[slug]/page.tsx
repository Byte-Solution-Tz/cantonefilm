...
export default function PortfolioProjectPage() {
  ...
  const nextProject = currentIndex < portfolio.length - 1
    ? portfolio[currentIndex + 1]
    : null;
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <Container>
          ...
          >
            ...
            <span className="inline-block px-4 py-2 bg-gold text-navy text-sm font-bold uppercase tracking-wider mb-4 w-fit">
              {project.category}
            </span>
            ...
            <div className="lg:col-span-2 space-y-12">
              <div>
                ...
                <p className="text-brown/80 leading-relaxed">
                  This project reflects our commitment to storytelling with
                  purpose—crafting visuals that resonate, educate, and inspire
                  real change.
                </p>
              </div>
